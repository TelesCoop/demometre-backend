# Generated by Django 3.2.11 on 2022-06-21 07:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('open_democracy_back', '0048_delete_closedwithrankingresponse'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objective_block_data', wagtail.core.fields.StreamField([('objective', wagtail.core.blocks.StructBlock([('svg', wagtailsvg.blocks.SvgChooserBlock(label='Icon au format svg')), ('title', wagtail.core.blocks.CharBlock(label='Titre'))], label='Objectif', label_format='Objectif : {title}'))], blank=True, verbose_name='Les objectifs')),
